...
-(void) addNotficationForObject:(ToDoObject*)obj fromNotficationCenter:(UNUserNotificationCenter*)center{
    ...
    UNCalendarNotificationTrigger* trigger = [UNCalendarNotificationTrigger
           triggerWithDateMatchingComponents:obj.CreationDate repeats:NO];
...
-(int)getObjectIndex:(NSIndexPath *)indexPath{
    ...
    NSArray<ToDoObject*> *data = [groupedDataSource objectAtIndex:indexPath.section];
    ToDoObject  *obj = [data objectAtIndex:indexPath.row];
    return [dataSource indexOfObject:obj];
...
- (void)searchBar:(UISearchBar *)searchBar textDidChange:(NSString *)searchText{
    ...
    NSString *qurey = [[@"Name beginswith[s]  '"stringByAppendingString:[searchText lowercaseString]]stringByAppendingString:@"'"];
...
-(void) ApplyOrderBy{
    ...
    filterdDataSource = [filterdDataSource sortedArrayUsingDescriptors:@[[NSSortDescriptor sortDescriptorWithKey:qurey ascending:YES]]];
}
-(void)ApplyGroupBy{
